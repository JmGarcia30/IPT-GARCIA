            ...
            <Container className="p-1 p-lg-5 d-flex align-items-center justify-content-center flex-column border my-5 rounded-4">
                ...
                <Form className="my-3 p-3 col-12 col-lg-4" onSubmit={register}>
                    ...
                    <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                        <Form.Control type="text" placeholder="First Name" required onChange={e => setFname(e.target.value)} value={fname} />
                    </Form.Group>

                    <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                        <Form.Control type="text" placeholder="Middle Name" required onChange={e => setMname(e.target.value)} value={mname} />
                    </Form.Group>

                    <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                        <Form.Control type="text" placeholder="Last Name" required onChange={e => setLname(e.target.value)} value={lname} />
                    </Form.Group>
                    ...
                    <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                        <Form.Control type="password" placeholder="Confirm Password" required onChange={e => setConfirmPass(e.target.value)} value={confirmPass} />
                    </Form.Group>
